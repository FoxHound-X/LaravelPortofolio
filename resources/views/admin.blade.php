...
<head>
    ...
    <title>Clover Hotel — Admin Panel</title>
    ...
    <aside id="sidebar">
        <div class="brand">
            <div class="brand-logo">
                ...
                <div>
                    <div class="brand-name">Clover Hotel</div>
            ...
            <section class="section active" id="dashboard">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <span style="font-family:'IBM Plex Mono',monospace;font-size:10px;color:var(--muted);">HARI
                            INI</span>
                    </div>
                    <table>
                        <thead>
            ...
            <section class="section" id="daftar-kamar">
                <div class="card">
                    <div class="card-header">
                        ...
                        <form name="search" action="{{ route('finddatakamar') }}" method="GET"
                            class="form-inline">
                        ...
                        @if (Auth::user()->role == 'admin')
                            <button class="btn btn-primary" onclick="switchTab('tambah-kamar')">+ Tambah
                                Kamar</button>
                        @endif
                    </div>
                    <table>
            ...
            <section class="section" id="tambah-kamar">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <form action="/tambah" method="POST" class="p-6 space-y-6">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div class="form-group">
                                    ...
                                    <input name="no_kamar" type="text" placeholder="Contoh: 301"
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="lantai" type="number" placeholder="Contoh: 3"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                        required />
                                </div>
                                <div class="form-group">
                                    ...
                                    <input name="harga" type="number" placeholder="Contoh: 800000"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                        required />
                                </div>
                                <div class="form-group">
                                    ...
                                    <input name="kapasitas" type="number" placeholder="Contoh: 2"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                                        required />
                                </div>
                                <div class="form-group">
                            ...
                            <div class="flex gap-4 pt-4">
                                <button
                                    class="bg-blue-600 text-white px-6 py-2 rounded-md hover:bg-blue-700 transition duration-200 flex items-center gap-2"
                                    type="submit" onclick="this.disabled=true; this.form.submit();">
                                    <i class="bi bi-save"></i>SIMPAN KAMAR
                                </button>
                                <button
                                    class="bg-gray-200 text-gray-700 px-6 py-2 rounded-md hover:bg-gray-300 transition duration-200"
                                    type="button" onclick="switchTab('daftar-kamar')">BATAL</button>
                            </div>
                        </form>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="p-6">
                            <p class="text-sm text-gray-600 mb-4">Upload file Excel untuk menambahkan data kamar secara
                                massal. Pastikan format sesuai dengan template.</p>
                            <form action="{{ route('import.datakamar') }}" method="POST"
                                enctype="multipart/form-data" class="space-y-4">
                                @csrf
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Pilih File
                                        Excel</label>
                                ...
                                <button type="submit"
                                    class="bg-green-600 text-white px-6 py-2 rounded-md hover:bg-green-700 transition duration-200 flex items-center gap-2">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div style="display:flex;align-items:center;gap:10px;">
                                                <div
                                                    style="width:28px;height:28px;background:var(--c2);border:2px solid var(--c3);display:flex;align-items:center;justify-content:center;font-family:'IBM Plex Mono',monospace;font-size:10px;color:var(--c3);">
                                                    SL</div>
                                                {{ $item->nama_pegawai }}
                                            </div>
                                        </td>
